    ...
    <div className="about-us-container">
      ...
      <section className="team-section bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-32">
          <h2 className="text-3xl font-bold text-center text-indigo-800 mb-12">فريق العمل</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Team Member 1 */}
            <div className="team-member text-center">
              <div className="w-40 h-40 mx-auto mb-4 rounded-full bg-indigo-100 flex items-center justify-center">
                <i className="fas fa-user text-5xl text-indigo-600"></i>
              </div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">محمد أحمد</h3>
              <p className="text-gray-600">مؤسس ومدير المنصة</p>
            </div>
            ...
            <div className="team-member text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">سارة محمود</h3>
              <p className="text-gray-600">مديرة المحتوى</p>
            </div>
            ...
            <div className="team-member text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">أحمد علي</h3>
